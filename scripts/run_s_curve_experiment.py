...
from trajectories.s_curve_lane_change import SCurveLaneChangeTrajectory
...
EXPERIMENTS = [
    {
        ...
        "log_path": LOG_DIR / "s_curve_free_payload.csv",
    },
    {
        "name": "fixed_payload",
        "model_path": ROOT / "models" / "scene_fixed.xml",
        "log_path": LOG_DIR / "s_curve_fixed_payload.csv",
    },
]
...
def run_single_experiment(model_path, log_path, experiment_name):
    ...
    trajectory = SCurveLaneChangeTrajectory(
        speed=0.6,
        amplitude=0.45,
        duration=8.0,
    )
    ...
    for _ in range(steps):
        ...
        rows.append({
            ...
            "payload_disp_x": payload_disp[0],
            "payload_disp_y": payload_disp[1],
            "payload_disp_z": payload_disp[2],
